...
namespace com::github::doevelopper::atlas::launcher::args
{
    ...
    private:
        ...
        virtual void parseArguments(
            boost::program_options::options_description desc, ProgramOption & options, int argc,
            char const * argv[]) const;

        virtual void parseEnvironment(
            boost::program_options::options_description & desc, ProgramOption & options) const;

        virtual void parseConfigFile(boost::program_options::options_description & desc, ProgramOption & options) const;
