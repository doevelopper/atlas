#ifndef COM_GITHUB_DOEVELOPPER_ATLAS_EXPORT_HPP
#define COM_GITHUB_DOEVELOPPER_ATLAS_EXPORT_HPP

#include <com/github/doevelopper/atlas/CompilerDetection.hpp>
#include <com/github/doevelopper/atlas/Poison.hpp>
#include <functional>
