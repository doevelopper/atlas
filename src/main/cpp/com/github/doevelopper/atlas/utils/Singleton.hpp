...
#ifndef COM_GITHUB_DOEVELOPPER_ATLAS_UTILS_SINGLETON_HPP
#define COM_GITHUB_DOEVELOPPER_ATLAS_UTILS_SINGLETON_HPP
...
namespace com::github::doevelopper::atlas::utils
{
    ...
    log4cxx::LoggerPtr Singleton< T >::logger =
        log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.atlas.utils.Singleton" ) );
