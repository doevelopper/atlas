With respect to C++ OOP , SOLID architecture pattern, and some design others design patterns you may find relevant, 
kindly leverage Boost StateChart framework  states and transitions from this description. A main.c code source should be provide to test the implementation
