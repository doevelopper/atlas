...
#include <com/github/doevelopper/atlas/time/TimeslicingTest.hpp>

using namespace com::github::doevelopper::atlas::time;
using namespace com::github::doevelopper::atlas::time::test;

log4cxx::LoggerPtr TimeslicingTest::logger =
    log4cxx::Logger::getLogger(std::string("com.github.doevelopper.atlas.time.TimeslicingTest"));

log4cxx::LoggerPtr SteadyClockMock::logger =
    log4cxx::Logger::getLogger(std::string("com.github.doevelopper.atlas.time.SteadyClockMock"));

TimeslicingTest::TimeslicingTest() noexcept
    // : m_targetUnderTest()
{
...
void TimeslicingTest::SetUp()
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    // m_targetUnderTest = new AlarmMock();
}

void TimeslicingTest::TearDown()
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
...
TEST_F(TimeslicingTest, EventLoopBasic)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
...
TEST_F(TimeslicingTest, EventLoopTotalOrdering)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    ...
    SteadyClockMock::reset();
/*
    Timeslicing<SteadyClockMock> evl;
...
TEST_F(TimeslicingTest, EventLoopPoll)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
...
TEST_F(TimeslicingTest, EventLoopDefer_single_overdue)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
...
TEST_F(TimeslicingTest, EventLoopDefer_long_running_callback)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
...
TEST_F(TimeslicingTest, HandleMovement)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
